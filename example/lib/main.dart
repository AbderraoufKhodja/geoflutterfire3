...
//       // return geo.collection(collectionRef: collectionReference).closest(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      if (lat != null && lng != null) _addPoint(lat, lng);
                    },
                    child: const Text(
                      'ADD',
              ...
              MaterialButton(
                ...
                onPressed: () {
                  final lat = double.tryParse(_latitudeController?.text ?? '');
                  final lng = double.tryParse(_longitudeController?.text ?? '');
                  if (lat != null && lng != null) _addNestedPoint(lat, lng);
                },
              )
            ],
          ),
...
//      _showHome();
  ...
  void _updateMarkers(List<DocumentSnapshot<Map<String, dynamic>>> documentList) {
    documentList.forEach((DocumentSnapshot<Map<String, dynamic>> document) {
      ...
      if (snapData == null) {
        debugPrint('Error: snapData is null');
        return;
      }
